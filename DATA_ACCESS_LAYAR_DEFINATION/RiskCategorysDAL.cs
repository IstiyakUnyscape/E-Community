...
{
    public class RiskCategorysDAL : IRiskCategorysDAL
    {
        private readonly Dapperr _dapper;
        public RiskCategorysDAL()
        {
            _dapper = new Dapperr();
        }
        public async Task<int> Create(RiskCategorysEntities entity)
        {
            var dbparams = new DynamicParameters();
            dbparams.Add("Risk_Category_Name", entity.Risk_Category_Name);
            ...
            var result = await Task.FromResult(_dapper.Insert<int>("sp_Insert_Risk_Categorys", dbparams, commandType: CommandType.StoredProcedure));
            return result;
        ...
        public async Task<int> Delete(int id)
        {
            ...
            var res = await Task.FromResult(_dapper.Update<int>("sp_Delete_Risk_Categorys", dbparams, commandType: CommandType.StoredProcedure));
            return res;
        }

        public IPagedList<RiskCategorysEntities> GetAll(SearchCompanyModel search)
        {
            var dbparams = new DynamicParameters();
            //dbparams.Add("Id", id, DbType.Int32);
            IQueryable<RiskCategorysEntities> result = _dapper.GetAll<RiskCategorysEntities>("sp_Get_Risk_Categorys", dbparams, commandType: CommandType.StoredProcedure).Distinct().AsQueryable();
            ...
            //}
            IOrderedQueryable<RiskCategorysEntities> OrderedQuery = null;

            if (!string.IsNullOrEmpty(search.SortColumn))
            {
                Type type = typeof(RiskCategorysEntities);
        ...
        public async Task<RiskCategorysEntities> GetById(int id)
        {
            var dbparams = new DynamicParameters();
            dbparams.Add("Id", id, DbType.Int32);
            var res = await Task.FromResult(_dapper.Get<RiskCategorysEntities>("sp_Get_Risk_Categorys_ById", dbparams, commandType: CommandType.StoredProcedure));
            return res;
        }

        public async Task<int> Update(RiskCategorysEntities entity)
        {
            var dbparams = new DynamicParameters();
            ...
            var result = await Task.FromResult(_dapper.Update<int>("sp_Update_Risk_Categorys", dbparams, commandType: CommandType.StoredProcedure));
            return result;
        }

        IEnumerable<RiskCategorysEntities> IRiskCategorysDAL.GetAll()
        {
            var dbparams = new DynamicParameters();
            var res = _dapper.GetAll<RiskCategorysEntities>("sp_Get_Risk_Categorys", dbparams, commandType: CommandType.StoredProcedure).AsEnumerable();
            return res;
        }
    }
}
